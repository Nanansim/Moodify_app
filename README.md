...
This project is an Expo (SDK 54) + React Native experience designed for Galaxy (Android) and iPhone devices. It helps users sync their daily rituals with their hormonal cycle and self-reported mood. Cards refresh automatically every day and can be adjusted to match personal cycle data.
